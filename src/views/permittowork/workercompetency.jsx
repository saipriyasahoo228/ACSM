...
//   // Open dialog for adding new worker competencies
...
//   // Function to check eligibility per permit
...
//   return (
//     <Box sx={{ p: 3 }}>
//       <Card sx={{ boxShadow: "0 6px 18px rgba(0,0,0,0.12)", borderRadius: 2 }}>
//         <CardHeader
//           title={
...
//           }
//           action={
//             <Button variant="contained" startIcon={<Add />} onClick={handleAddWorker} sx={{ backgroundColor: "#0A3A6E" }}>
//               Assign Competencies
//             </Button>
//           }
//         />
...
//                         variant="body2"
//                         sx={{
//                           color: isEligible(worker, p) ? "green" : "red",
//                           fontWeight: 600,
//                         }}
//                       >
//                         {isEligible(worker, p) ? "Eligible" : "Not Eligible"}
//                       </Typography>
//                     </TableCell>
//                   ))}
...
//               {workers.length === 0 && (
//                 <TableRow>
//                   <TableCell colSpan={5 + DUMMY_PERMITS.length} align="center" sx={{ py: 3 }}>
